...
export default function ProjectCard({ project }: Props) {
  const isPublished = !!project.students_projects.published_at // const isPublished = Boolean(project.students_projects.published_at);
  ...
  return isPublished ? (
    ...
    >
      ...
      <div className="p-5">
        ...
        <p className="text-sm text-gray-500 flex items-center gap-2">
          <span>📅</span>
          {isPublished && project.students_projects.published_at
    ...
    // 🟡 VERSION NON PUBLIÉE
    <div
      className="group block bg-white rounded-xl shadow-md hover:shadow-2xl overflow-hidden transition-all duration-300 border-2 relative opacity-60 border-dashed border-yellow-400 cursor-default"
    >
